...
tape('ABI translator', function (t: any) {
  t.test('Empty ABI', function (st: any) {
    st.deepEqual(abi.update('0.4.0', []), []);
    st.end();
  });
  t.test('0.1.1 (no constructor)', function (st: any) {
  ...
  t.test('0.3.6 (constructor)', function (st: any) {
  ...
  t.test('0.3.6 (non-constant function)', function (st: any) {
  ...
  t.test('0.3.6 (constant function)', function (st: any) {
  ...
  t.test('0.3.6 (event)', function (st: any) {
  ...
  t.test('0.3.6 (has no fallback)', function (st: any) {
    var input = [ { inputs: [], type: 'constructor' } ];
  ...
  t.test('0.4.0 (has fallback)', function (st: any) {
  ...
  t.test('0.4.1 (constructor not payable)', function (st: any) {
